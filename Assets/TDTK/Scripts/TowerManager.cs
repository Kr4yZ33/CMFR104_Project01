...
namespace TDTK{
	...
	public class TowerManager : MonoBehaviour {
			...
			*/
			...
			if(dndTower!=null && Time.unscaledTime-dndCooldown>0.15f){
				...
				if(lastDnDCursorPos!=cursorPos){
					...
					else dndTower.transform.position=Camera.main.ScreenToWorldPoint(cursorPos+new Vector3(0, 0, 15));
				}
		...
		*/
		...
		public static void BuildTower(UnitTower prefab, BuildPlatform platform, int nodeID, bool useRsc=true, bool updatePath=true){
			if(useRsc){
